...
public class DegraphTask extends DefaultTask {
    ...
    private Property<DegraphConfiguration> configuration;
    ...
    public DegraphTask(final WorkerExecutor workerExecutor) {
        ...
        this.configuration = objectFactory.property(DegraphConfiguration.class);
    ...
    @Input
    public Property<DegraphConfiguration> getConfiguration() {
    ...
    public void runConstraintCheck() {
        ...
        workQueue.submit(DegraphWorker.class, parameters -> {
